  ...
  constructor(private route: ActivatedRoute, private router: Router) {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      switch(this.animal.risco_extincao){
        case "EX": 
          this.risco_extinsao.src = "assets/redlist/ex.png";
          this.risco_extinsao.alt = "Extinto";
          break;
        case "EW":  
          this.risco_extinsao.src = "assets/redlist/ew.png";
          this.risco_extinsao.alt = "Extinto na natureza";
          break;
        case "CR": 
          this.risco_extinsao.src = "assets/redlist/cr.png";
          this.risco_extinsao.alt = "Criticamente em perigo";
          break;
        case "EN": 
          this.risco_extinsao.src = "assets/redlist/en.png";
          this.risco_extinsao.alt = "Em perigo";
          break;
        case "VU": 
          this.risco_extinsao.src = "assets/redlist/vu.png";
          this.risco_extinsao.alt = "Vulnerável";
          break;
        case "NT": 
          this.risco_extinsao.src = "assets/redlist/nt.png";
          this.risco_extinsao.alt = "Quase Ameaçada";
          break;
        case "LC": 
        default:
          this.risco_extinsao.src = "assets/redlist/lc.png";
